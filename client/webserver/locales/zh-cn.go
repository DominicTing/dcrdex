...
var ZhCN = map[string]*intl.Translation{
	...
	"immediate_explanation":          {T: "如果订单在下一个匹配周期内不能完全匹配，不匹配的数量将不会被再次匹配。需重新设置订单。"},
	"Immediate or cancel":            {T: "无法完全匹配即取消"},
	"Balances":                       {T: "余额"},
	...
	"Host":                        {T: "主机"},
	"No Recent Activity":          {T: "近期没有交易"},
	"Recent asset_name Activity":  {T: "近期的 <span data-asset-name=1></span> 交易"},
	"other_actions":               {T: "其它活动"},
	"estimated_fee":               {T: "预估费用"},
	"estimated_total_spend":       {T: "预估总支出"},
	"estimated_balance":           {T: "完成之后的预估余额"},
	"max_estimated_send":          {T: "预计最多发送"},
	"max_estimated_send_fee":      {T: "预估最大网络费用"},
	"sending":                     {T: "发送"},
	"transfer":                    {T: "交易"},
